...
export const kelasAPI = {
  ...
  create: (data) => fetchAPI('/kelas', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => fetchAPI(`/kelas/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const siswaAPI = {
  ...
  create: (data) => fetchAPI('/siswa', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => fetchAPI(`/siswa/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
...
export const nilaiAPI = {
  ...
  create: (data) => fetchAPI('/nilai', { method: 'POST', body: JSON.stringify(data) }),
  update: (id, data) => fetchAPI(`/nilai/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
